...
num_threads=40
ram_gb=64
for saaf_or_font in font saaf; do
    for n in $(seq 2 10); do
        ## For files ss_lib_bkup_gen_3x3_SAAF_mox_fis_iga_proc
        ## 9x9_uniform_uox_fis_saaf_iga_sub_4.x2m
        inp_x2m_file_name="${n}x${n}_uniform_uox_fis_${saaf_or_font}_iga_sub_1.x2m"
        filename="${n}x${n}_${saaf_or_font}_iga_sub_1_scaling.pbs"
